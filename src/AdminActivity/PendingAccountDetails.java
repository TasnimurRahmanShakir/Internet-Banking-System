...
public class PendingAccountDetails extends javax.swing.JFrame {

    java.sql.ResultSet rs1, rs2, rs3;

    public PendingAccountDetails(String formNo) {
        initComponents();
        setBounds(129, 128, 1280, 650);

        DBConnection c = new DBConnection();
        try {
            String q = "SELECT * FROM registerone WHERE formNo = '" + formNo + "'";
        ...
        try {
            String q1 = "SELECT * FROM registertwo WHERE formNo = '" + formNo + "'";
            rs2 = c.s.executeQuery(q1);
            if (rs2.next()) {
                relegion.setText(rs2.getString("relegion"));
                eduction.setText(rs2.getString("education"));
                ocupation.setText(rs2.getString("ocupation"));
                income.setText(rs2.getString("income"));
                adress.setText(rs2.getString("adress"));
                postCode.setText(rs2.getString("postCode"));
            }
        ...
        try {
            String q1 = "SELECT * FROM registerthree WHERE formNo = '" + formNo + "'";
            rs3 = c.s.executeQuery(q1);
            if (rs3.next()) {
                catagory.setText(rs3.getString("catagory"));
                services.setText(rs3.getString("services"));
                cardNumber.setText(rs3.getString("cardNumber"));
            }
        } catch (SQLException e) {
            String errorMessage = "SQL Exception: " + e.getMessage();
            JOptionPane.showMessageDialog(null, errorMessage, "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void initComponents() {
        ...
        jPanel1.add(WelcomeText, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 330, 190, 40));
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 270, 180, 40));

        jLabel3.setFont(new java.awt.Font("Yu Gothic UI Semilight", 0, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Of");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 300, 180, 40));

        photo.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2));
        jPanel1.add(photo, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 40, 170, 190));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new PendingAccountDetails("").setVisible(true);
            }
        });
    }
